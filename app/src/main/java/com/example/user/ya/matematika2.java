...
public class matematika2 extends AppCompatActivity {
    ...
    soalmtk2 mtkk = new soalmtk2();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.setTitle( "Latihan Soal Matematika 2");
        setContentView(R.layout.activity_matematika2);
    ...
    public void setKonten() {
        ...
        if (x >= arr) { //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(matematika2.this, HasilSkoring.class);
            ...
            mtvSoal2.setText(mtkk.getPertanyaan(x));
            ubahGambar();
            mrbPilihanJawaban1.setText(mtkk.getPilihanJawaban1(x));
            mrbPilihanJawaban2.setText(mtkk.getPilihanJawaban2(x));
            mrbPilihanJawaban3.setText(mtkk.getPilihanJawaban3(x));
            mrbPilihanJawaban4.setText(mtkk.getPilihanJawaban4(x));
            jawaban = mtkk.getJawabanBenar(x);
        }
        x++;
    }
    ...
    public void ubahGambar() {
        ...
        String mPhoto = mtkk.getStringGambar(x);
