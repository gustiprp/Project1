...
public class ipa2 extends AppCompatActivity {
    ...
    soalipa2 ipaa = new soalipa2();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.setTitle( "Latihan Soal IPA 2");
    ...
    public void setKonten() {
        ...
        if (x >= arr) { //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(ipa2.this, HasilSkoring.class);
            ...
            mtvSoal2.setText(ipaa.getPertanyaan(x));
            ubahGambar();
            mrbPilihanJawaban1.setText(ipaa.getPilihanJawaban1(x));
            mrbPilihanJawaban2.setText(ipaa.getPilihanJawaban2(x));
            mrbPilihanJawaban3.setText(ipaa.getPilihanJawaban3(x));
            mrbPilihanJawaban4.setText(ipaa.getPilihanJawaban4(x));
            jawaban = ipaa.getJawabanBenar(x);
        }
        x++;
    }
    ...
    public void ubahGambar() {
        ...
        String mPhoto = ipaa.getStringGambar(x);
